...
function creerPanneau(nom,opts,scn){
	...
	let panneau = BABYLON.MeshBuilder.CreatePlane(nom,{width:largeur,height:hauteur},scn) ;

	panneau.name       = nom ; 
	panneau.material   = materiau ; 
	panneau.parent     = groupe ; 
	panneau.position.y = hauteur / 2.0 ; 
